...
```
# 3.4 Ответ: В поле (в каждом из полей) Слово лексико-грам. поиска нужно указывать лишь одну конкретную лексему или словоформу. В то время как в поле Поиск точных форм может осуществляться поиск с указанием нескольких слов. Соответственно, если в поле Слово лексико-грам. поиска набрать 'баба с возу', запрос будет пустой, т.к. мы ищем 3 слова. 
```
...
```
# 6.1 Лемм со счетной формой: 2: шар, ряд
```
